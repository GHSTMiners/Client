...
export default class KeyboardInputManager extends Phaser.GameObjects.GameObject {
    constructor(scene : Phaser.Scene) {
        ...
        this.scene.game.events.on( gameEvents.chat.SHOW, ()=>{this.setMenuMode()} );
        this.scene.game.events.on( gameEvents.chat.HIDE, ()=>{this.setGameMode()} );
        this.scene.game.events.on( gameEvents.shop.SHOW, ()=>{this.setMenuMode()} );
        this.scene.game.events.on( gameEvents.shop.HIDE, ()=>{this.setGameMode()} );
        this.scene.game.events.on( gameEvents.dialogs.HIDE, ()=>{this.setGameMode()} );
    }
    ...
    private addAllKeys=()=>{
        ...
        this.keys.set(Phaser.Input.Keyboard.KeyCodes.FIVE, this.scene.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.FIVE, true, false))
        ...
        this.keys.set(Phaser.Input.Keyboard.KeyCodes.NUMPAD_FIVE, this.scene.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.NUMPAD_FIVE, true, false))
    ...
    private setMenuMode=()=>{
        ...
        this.keys.set(Phaser.Input.Keyboard.KeyCodes.ESC, this.scene.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.ESC, true, false) );
        this.keys.forEach(key => {
            key.on('down', ()=>{this.keysChangedInMenu()} )
            key.on('up', ()=>{this.keysChangedInMenu()}) 
        }, this)
    }
    ...
    private keysChangedGaming() {
        ...
        if(this.keys.get(Phaser.Input.Keyboard.KeyCodes.FIVE)?.isDown || this.keys.get(Phaser.Input.Keyboard.KeyCodes.NUMPAD_FIVE)?.isDown ) {
            this.scene.game.events.emit( gameEvents.console.SHORTCUT, 5 )
        }
