...
export class RefineAnimation extends Phaser.GameObjects.Container {
    constructor(scene: Phaser.Scene, cryptoID : string ) {
        ...
        const buildings = Client.getInstance().chiselWorld.buildings;
        const refinary = buildings.filter( building => building.type === 'Refinery')
        ...
        this.setPosition( Config.blockWidth * refinary[0]?.spawn_x + 4*Config.blockWidth , -Config.blockHeight *4  )
