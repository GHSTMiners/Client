...
export const VOLUMENPOWERORDER = 4; // to get a exponential feeling for the volume sliders, more natural

export const maintenanceTimeON = new Date('April 04, 2023 14:00:00 UTC').getTime() ;
export const maintenanceTimeOFF = new Date('April 12, 2023 14:00:00 UTC').getTime() ;
