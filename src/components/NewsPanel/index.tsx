...
export const NewsPanel = () => {
  ...
  type newsEntry = { title: string, content: string};
   ...
   newsArray.push({
     title: "🔥 Stress Test",
     content: "GotchiMiner is almost ready for launch! Come and join us during August in the first stress test of the game. Cooperate with your frens or compite to mine all the precious crypto crystals, the choice is yours!"
   });
   newsArray.push({
