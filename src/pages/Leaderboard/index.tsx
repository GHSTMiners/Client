...
const Leaderboard = (): JSX.Element => {
  ...
  const endDate = new Date('April 04, 2023 14:00:00 UTC') ;
  const getReward = (position : number , score:  number):string => {
    /*
    if (position === 1) {
      return "PICKAXE + HoF FG + 15XP"
    } else if (position === 2 ) {
      return "MINER HELMET + HoF FG + 15XP"
    } else if (position === 3 ) {
      return "MINER HELMET + HoF GF + 15XP"
    } else if (position === 4 ) {
      return "MINER JEANS + HoF FG + 15XP"
    } else if (position === 5 ) {
      return "MINER JEANS + HoF FG + 15XP"
    } else if (position <= 10 ) {
      return "HoF FG + 15XP"
      ...
      return "10 XP"
    } else if (position > 500 && score >= 10000) {
      return "5 XP"
    } else {*/
      return ""
    //}
