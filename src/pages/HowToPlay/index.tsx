          ...
          <div className={globalStyles.tileContent}>
            <div className={styles.traitList}>
              <div className={styles.traitElement}> 
                ...
                Turnt gotchis drill very fast, Zen gotchis are more fuel efficient. 
              </div> 
              <div className={styles.traitElement}> 
                <img src={agg} className={styles.traitIcon} alt={'Aggresiveness'}/>
                Based gotchis move really fast. Nonviolent gotchis have better cargo. 
              </div> 
              <div className={styles.traitElement}> 
              ...
              <div className={styles.traitElement}> 
                ...
                Galaxy brains are great at refining crypto. {/*Smol brains get discounts on explosives.*/}
              </div> 
            </div>
          </div>
        </div>
