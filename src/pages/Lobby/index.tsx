...
const Lobby = (): JSX.Element => {
  ...
  useEffect(() => {
              ...
              Client.getInstance().apiInterface.world(Client.getInstance().lobbyRoom.state.map_id).then(world =>{
                ...
                Client.getInstance().colyseusClient.joinById<Schema.World>(Client.getInstance().lobbyRoom.state.game_id, Client.getInstance().authenticationInfo).then(room => {
                    ...
                    room.onLeave(()=>{
                      ...
                      Client.getInstance().messageRouter = new Protocol.MessageRouter();
                      Client.getInstance().lobbyMessageRouter = new Protocol.MessageRouter();
    ...
    return () => {
      //Triggering useEffect cleaning cycle
      Client.getInstance().lobbyRoom.state.onChange = () => {}
      Client.getInstance().lobbyRoom.state.player_seats.onChange = () => {}
      Client.getInstance().lobbyRoom.removeAllListeners();
    }
